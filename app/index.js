...
var Generator = module.exports = function Generator( args, options ) {
	...
	this.hookFor( 'spangle:common', {
		args: args
	} );

	this.hookFor( 'spangle:main', {
		args: args
	} );

	this.hookFor( 'spangle:config', {
		args: ['config']
	} );

	this.hookFor( 'spangle:restFactory', {
		args: ['restFactory']
	} );
	
	this.hookFor( 'spangle:pageCtrl', {
		args: ['page']
	} );

	this.hookFor( 'spangle:pageFactory', {
		args: ['pageFactory']
	} );

	this.hookFor( 'spangle:menuFactory', {
		args: ['menuFactory']
	} );
...
Generator.prototype.appJs = function appJs() {
	this.indexFile = this.appendFiles( {
		...
		sourceFileList: [ 'scripts/app.js', 'scripts/lib/console-log.js', 'scripts/lib/grunticon.js', 'scripts/lib/piwik.js', 'scripts/utillities/utillities.js' ],
