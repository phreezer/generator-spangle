...
Generator.prototype.bootstrapFiles = function bootstrapFiles() {
	...
	this.directory(path.join('app', 'scripts/utillities'),path.join(this.appPath, 'scripts/utillities'));
	this.directory(path.join('app', 'scripts/lib'),path.join(this.appPath, 'scripts/lib'));
	this.directory(path.join('app', 'styles'),path.join(this.appPath, 'styles'));
	this.directory(path.join('app', 'json'),path.join(this.appPath, 'json'));
	this.directory(path.join('app', 'fonts'),path.join(this.appPath, 'fonts'));
...
Generator.prototype.appJs = function appJs() {
	...
	sourceFileList: ['scripts/app.js', 'scripts/lib/console-log.js', 'scripts/lib/piwik.js', 'scripts/utillities/utillities.js'],
